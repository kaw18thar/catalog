        ...
        try:
            ...
            if self.path.endswith("/delete"):
                ...
                if myRestaurantQuery != [] :
                    ...
                    output = ""
                    output += "<html><body>"
                    output += "<p > Are you sure you want to remove %s" % myRestaurantQuery.name
                    output += " permenantly? </p >"
                    output += "<form method='POST' enctype='multipart/form-data' action='/restaurants/%s/delete'>" % restaurantIDPath
                    output += "<button type = 'submit'> Delete restaurant </button> "
                    output += "</form>"
                    output += "<a href='/restaurants'> back to restaurants  </a></html></body>"
                    self.wfile.write(output)
